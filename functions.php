...
function enqueue_styles() {
    ...
    wp_enqueue_style( 'cabral-style', get_stylesheet_uri() );

    // Enqueue the custom WooCommerce stylesheet
    wp_enqueue_style( 'custom-woocommerce', get_template_directory_uri() . '/custom-woocommerce.css', array('cabral-style') );
}
